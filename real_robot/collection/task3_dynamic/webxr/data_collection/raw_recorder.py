...
class RawEpisodeRecorder:
    ...
    def save(self, data):
        ...
        for key in ('collection_purpose', 'preparation_batch', 'training_eligible', 'translation_gain', 'rotation_gain',
                    ...
                    'relocation_plan_index', 'planned_destination_direction',
                    'relocation_trigger', 'destination_markers_present',
                    'actual_destination_position', 'relocation_event_verified'):
            if key in metadata:
