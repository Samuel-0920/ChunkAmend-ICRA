...
def main():
 ...
 for config in ['pi05_uf850_fruit_organization','pi05_uf850_fruit_organization_lora']:
  normalize.save(B/'training/openpi/assets'/config/'local/uf850_fruit_organization_v001',result)
