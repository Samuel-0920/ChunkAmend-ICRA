...
from chunkamend.simulation.core.methods.m1_integration import COVER_SCREEN_METHOD_IDS
from chunkamend.simulation.core.methods.m1_integration import M1Context
from chunkamend.simulation.core.methods.m1_integration import MethodId
...
def _immutable_action_copy(value: np.ndarray, *, label: str) -> np.ndarray:
    ...
    if (
        ...
        raise ValueError(f"{label} must be a finite floating (10,7) action chunk")
