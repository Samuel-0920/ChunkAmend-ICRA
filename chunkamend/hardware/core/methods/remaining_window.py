...
import numpy as np
from chunkamend.hardware.core.methods import numeric_dispatch, exact_cycle, box_certificate, compiled_bridge, compiled_projection
from chunkamend.hardware.core.shared.feedback_window import validate_feedback_window, validate_memory_context
from chunkamend.hardware.core.methods.m1_types import valid_remaining_shape
from chunkamend.hardware.core.methods.rap_cover import RapCoverCore
from chunkamend.hardware.core.methods.rap_response import fit_completed_translation_response
from chunkamend.hardware.core.methods.rap_response_6d import fit_completed_six_d_response, Q6D_ACTION_REPRESENTATION
from chunkamend.hardware.core.methods.rap_response_6d_active import ActiveResponseState
from chunkamend.hardware.core.methods.rotation_boundary import RotationBoundaryCorrector, ENDPOINT_FRACTIONS, minimum_jerk_weights, ROT_REF
...
class WindowCorrector:
    def __init__(self,cfg,q_mode,rotation_arm,q01,q99,*,ranking_correction_penalty=None,memory_response=False,memory_state_ridge=1e-4,terminal_veto=True):
        ...
        from chunkamend.hardware.core.methods.rap_cover import _validate_ranking_penalty
        ...
        with ExitStack() as scopes:
            ...
            if self.q_mode=='Q6':
                ...
                if self.memory_response:
                    from chunkamend.hardware.core.methods.memory_integration import fit_memory_adapter
