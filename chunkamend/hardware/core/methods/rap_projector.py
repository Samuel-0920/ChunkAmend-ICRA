...
import numpy as np
from chunkamend.hardware.core.methods import compiled_projection
from chunkamend.hardware.core.methods.numeric_dispatch import solve3_f64
from chunkamend.hardware.core.methods import exact_cycle, box_certificate
...
from chunkamend.hardware.core.methods.m1_types import RESPONSE_PREDICTION_TRANSLATION_ONLY
...
def physical_continuity_components(
    ...
    *,
    ...
    if not valid_remaining_shape(value, 7) or not np.isfinite(value).all():
        raise ValueError("chunk must be finite [15,7]")
...
def _affine_balls(
    ...
    *,
    ...
    if response.prediction_semantics == RESPONSE_PREDICTION_Q3_MEMORY:
        ...
        from chunkamend.hardware.core.methods.temporal_affine import build_prefix_constraints
